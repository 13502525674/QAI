<template>
<div>
  <el-dialog title="发起讨论" width="40%" :destroy-on-close="true" :visible.sync="addVisible" :before-close="handleClose">
        ...
        <el-col style="margin-top:20px" :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
              <el-form-item prop="content" style="margin-bottom:0">
                  <el-input type="textarea" :rows="5" v-model="form.content" size="mini" placeholder="请输入讨论内容" autocomplete="off"></el-input>
              </el-form-item>
            </div>
        </el-col>
      </el-row>
    ...
    <div slot="footer" class="dialog-footer">
      <el-button size="mini" type="primary" @click="submit">发 起</el-button>
