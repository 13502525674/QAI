...
//获取最新评论
export const getLatestComments = () => get("/index/getLatestComments")
...
//获取所有学生考试成绩（用于大屏可视化）
export const getAllStudentScores = () => get("/test/getAllStudentScores")
...
//-------------------------------物理题库文档解析---------------------------------------
// 解析物理题库文档
export const parsePhysicsDocument = (params) => post("/physics/document/parse",params)
// 解析并保存物理题库文档
export const parseAndSavePhysicsDocument = (params) => post("/physics/document/parseAndSave",params)

//-------------------------------物理试卷管理---------------------------------------
// 查询物理试卷分页列表
export const getPhysicsQuestionPaperPage = (params) => post("/physics/questionPaper/getPage",params)
// 查询物理试卷列表
export const getPhysicsQuestionPaperList = (params) => post("/physics/questionPaper/getPhysicsQuestionPaperList",params)
// 新增物理试卷
...
// 批量删除物理试卷
export const removeBatchPhysicsQuestionPaper = (params) => post("/physics/questionPaper/removeBatchPhysicsQuestionPaper",params)

//-------------------------------物理练习记录---------------------------------------
// 查询物理练习记录分页列表
export const getPhysicsPracticeRecordsPage = (params) => post("/physics/practiceRecords/getPage",params)
// 查询物理练习记录列表
export const getPhysicsPracticeRecordsList = (params) => post("/physics/practiceRecords/getList",params)
// 新增物理练习记录
export const savePhysicsPracticeRecords = (params) => post("/physics/practiceRecords/save",params)
// 根据id查询物理练习记录
export const getPhysicsPracticeRecordsById = (params) => get("/physics/practiceRecords/getById",params)
// 更新物理练习记录
export const editPhysicsPracticeRecords = (params) => post("/physics/practiceRecords/edit",params)
// 删除物理练习记录
export const removePhysicsPracticeRecords = (params) => get("/physics/practiceRecords/remove",params)
// 提交物理练习
...
//-------------------------------Dashboard Mocks---------------------------------------
export const getDashboardAICallStats = () => {
    return Promise.resolve({
        ...
        data: {
            ...
            practiceTrend: [
                ...
                { date: '02-02', count: 132 },
                { date: '02-03', count: 101 },
                { date: '02-04', count: 134 },
                { date: '02-05', count: 90 },
                { date: '02-06', count: 230 },
                { date: '02-07', count: 210 }
            ]
        }
    });
}

export const getDashboardQuestionBankStats = () => {
    return Promise.resolve({
        code: 1000,
        data: {
...
export const getDashboardIndexData = () => {
    return Promise.resolve({
        code: 1000,
        data: {
            userNum: 1250,
...
export const getDashboardTaskIndexList = () => {
    return Promise.resolve({
        code: 1000,
        data: [
            { courseName: 'Python基础教程', count: 120 },
            { courseName: 'Java进阶实战', count: 95 },
            { courseName: 'Vue3全栈开发', count: 88 },
            { courseName: 'Spring Boot微服务', count: 76 },
            { courseName: '机器学习入门', count: 65 }
        ]
    });
}
...
export const getAiHistoryCount = () => get("/ai/history/count")

//-------------------------------趣味物理---------------------------------------
// 物理学家朋友圈
export const getFunPhysicsMomentsPage = (params) => post("/funphysics/moments/getPage",params)
export const getFunPhysicsMomentsById = (params) => get("/funphysics/moments/getById",params)
export const saveFunPhysicsMoments = (params) => post("/funphysics/moments/save",params)
export const editFunPhysicsMoments = (params) => post("/funphysics/moments/update",params)
export const removeFunPhysicsMoments = (params) => get("/funphysics/moments/remove",params)

// 趣味问题
export const getFunPhysicsQuestionPage = (params) => post("/funphysics/question/getPage",params)
export const getFunPhysicsQuestionById = (params) => get("/funphysics/question/getById",params)
export const saveFunPhysicsQuestion = (params) => post("/funphysics/question/save",params)
export const editFunPhysicsQuestion = (params) => post("/funphysics/question/update",params)
export const removeFunPhysicsQuestion = (params) => get("/funphysics/question/remove",params)

// 物理拼图
export const getFunPhysicsPuzzlePage = (params) => post("/funphysics/puzzle/getPage",params)
export const getFunPhysicsPuzzleById = (params) => get("/funphysics/puzzle/getById",params)
export const saveFunPhysicsPuzzle = (params) => post("/funphysics/puzzle/save",params)
export const editFunPhysicsPuzzle = (params) => post("/funphysics/puzzle/update",params)
export const removeFunPhysicsPuzzle = (params) => get("/funphysics/puzzle/remove",params)

//-------------------------------系统监控---------------------------------------
// 获取系统负载信息
export const getSystemLoad = () => get("/monitor/load")
// 获取详细监控数据
export const getDetailedMonitor = () => get("/monitor/detailed")
