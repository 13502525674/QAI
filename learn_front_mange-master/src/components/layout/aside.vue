    ...
    <el-aside :width="isCollapse ? '64px' : '240px'">
        <div class="back-icon" :style="{width: isCollapse ? '63px' : '239px'}">
            <span class="logo-text" :class="isCollapse? 'xiaoshi':''">
                <span style="background:#FDEBD3;color:#657166">&nbsp;智学伴&nbsp;</span>
                <span> ADMIN</span>
            </span>
        </div>
        <el-menu
...
<style scoped lang="scss">
    ...
    .el-submenu>>>.el-submenu__title:hover {
        ...
        background-color: rgba(253, 235, 211, 0.12)!important;
    } 
    ...
    .el-menu-vertical:deep(.el-menu-item.is-active) {
        background-color: rgba(253, 235, 211, 0.15)!important;
        box-shadow:inset 5px 0 #F3C3B2; 
    }
