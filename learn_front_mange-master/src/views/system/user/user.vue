<template>
  <div class="user">
    <div class="tree">
        <el-input style="margin:10px;width:90%"
            prefix-icon="el-icon-search"
            size="mini"
            placeholder="输入部门名称进行过滤"
            v-model="filterText">
        </el-input>
        <el-tree style="font-family:'黑体'" default-expand-all :expand-on-click-node="false" :filter-node-method="filterNode" ref="tree" class="filter-tree" :data="data" :props="defaultProps" @node-click="handleNodeClick"></el-tree>
    </div>
