...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry){
        ...
        // 聊天图片地址
        registry.addResourceHandler("/chatApi/images/**").addResourceLocations(
                "file:"+System.getProperty("user.dir")+System.getProperty("file.separator")+"chat-uploads"+System.getProperty("file.separator")
        );
    }
